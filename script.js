...
const questions = [
  {
    title: "You're 4th place right now in a race. What place will you be in when you pass the person in 3rd place?",
  ...
  },
  {
    ...
    options: ["2", "1", "Depends if there's a leap year or not","All of them"],
    answer: "3",
    score: 1
  },
  {
    ...
    options: ["Paul III", "Paul", "Jimmy", "Can't say!"],
    answer: "2",
    score: 1
  }
  ,
  {
    ...
    options: ["Gold", "Magnesium", "Salt", "Silver"],
    answer: "0",
    score: 1
  }
  ,
  {
    ...
    options: ["Dark chocolate", "Honey", "Peanut butter", "Canned tuna"],
    answer: "1",
    score: 1
  }
];
